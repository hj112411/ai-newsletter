...
```yaml
owner: Jin
pages_url: https://hj112411.github.io/ai-newsletter   # 내 GitHub Pages 주소. 저장소 Settings → Pages에서 확인
...
interests:                      # 관심사 = 탭. 추가/삭제 자유. 2~5개 권장.
  ...
  - id: tools
    ...
    icon: 🔥
    tint: purple
    kind: role             # 속보가 아니라 '지금 화제인 도구' 큐레이션 — 날짜 필터 대신 화제성 기준
    focus: 지금 온라인에서 가장 많이 언급·논의되는 AI 도구. 영향 범위와 화제성, 출처 신뢰도 위주로 고른다.
